...
import {Column, Row, QuoteBox, CardBox, Button } from "./styleCompnents/container.Style";
...
function Home (){
   ...
   experiences that<span style={{color:"#32620E", fontWeight: "700"}}> simplify people's lives.</span>
